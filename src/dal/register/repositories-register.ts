...
import { CustomMeasureableValueRepository } from "../custom-measureable-value-repository";
...
export const registerRepositories = (container: DependencyContainer) => {
    ...
    container.register<CustomMeasureableValueRepository>('CustomMeasureableValueRepository', CustomMeasureableValueRepository);
}